...
namespace LibraryNetCoreAPI
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddSwaggerGen(config =>
            {
                config.SwaggerDoc("v1", new OpenApiInfo() { 
                    Title = "Web API",
                    Description = "Este es un api para el control de una biblioteca, donde se manejan libros y autores, tambi�n comentarios de libros",
                    Version = "version 1",
            ...
            services.AddAuthorization(options =>
                ...
                //options.AddPolicy("isSeller", x => x.RequireClaim("isSeller")) se puede agregar varias pol�ticas segun usuarios
            );

            //Encriptacion y desencriptaci�n
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            //Configuraci�n de middleware SWAGGER
            app.UseSwagger();
